...
class Toggle extends React.Component {
   ...
   constructor(props) {
      ...
      this.toggleId = this.props.item.entry.id + "_enabledToggle";
   }

   onToggle() {
      xhr.put(`${this.url}/${this.props.item.entry.id}`, {
   ...
   componentDidUpdate() {
      ...
      if (this.props.item.entry.enabled)
      {
      ...
      return (
         <label ref="componentNode" 
            ...
            <input type="checkbox" 
                   ...
                   checked={this.props.item.entry.enabled} 
